...
// import { ApiSchema } from '@/plugins/apollo/helpers'
...
declare namespace Cypress {
  interface Chainable {
     ...
     * @example
     * cy.gqlRequest(ApiSchema/Public, '/api/communication/alerts', 'Create Alert');
     */
    gqlRequest(schema: ApiSchema, gqlQuery: object, gqlVariables: object, message: string): void
